...
dates = {}
doc = REXML::Document.new('<svg xmlns="http://www.w3.org/2000/svg" version="1.1" onload="init(evt)"></svg>')
...
(0...24).each { |hour|
  ...
  line.attributes['x2'] = X_SPACE_PER_DAY * DAYS_SHOWN
  ...
  text.attributes['x'] = X_SPACE_PER_DAY * DAYS_SHOWN
